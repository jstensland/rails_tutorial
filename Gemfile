...
# This is used for populating fake users.
gem 'faker',                '1.4.2'

# used to paginate users
...
group :production do
  gem 'pg',             '0.17.1'
  gem 'rails_12factor', '0.0.3'  #this is not working for me.  logout and scss compilation not working
  gem 'unicorn',        '4.8.3'
end
